...
Canonical integrity is stored in `kenneth_french_current_snapshot_2026-06.json`, including the upstream ZIP SHA-256, extracted CSV SHA-256, normalized-file SHA-256, row count, and first/last observation for each factor family.
