...
| EDINET-Bench | Japanese filing NLP benchmark for fraud, earnings forecast, and industry prediction | paper benchmark | CONTRACT_PARTIAL | NOT_RUN | task-native Accuracy/F1/Macro-F1 on frozen split | BLOCKED | [edinet_bench.md](./edinet_bench.md) |
