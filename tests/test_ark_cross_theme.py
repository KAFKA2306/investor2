...
class ArkCrossThemeTest(unittest.TestCase):
    ...
    def test_bitcoin_derivatives_keep_perpetual_and_delivery_separate(self):
            ...
            "records": [
                {
                    ...
                    "perpetual_premium_pct": -0.03,
                },
                {
                    "date": "2026-08-19",
                    "contract_type": "CURRENT_QUARTER",
                    "symbol": "BTCUSDT_260925",
                    "annualized_delivery_basis_pct": 2.1,
                },
            ]
        }
        ...
        self.assertEqual(
            by_entity["BTCUSDT"],
            {"funding_rate_sum", "perpetual_premium_pct"},
        )
        self.assertEqual(
            by_entity["BTCUSDT_260925"],
            {"annualized_delivery_basis_pct"},
        )
    ...
    def test_source_readiness_and_metric_feeds_must_match_one_to_one(self):
        ...
        metric_catalog: dict[str, Any] = {"feeds": []}
