...
def evaluate(
    *,
    ...
    selected_codes = [
        str(code)
        for code in cast(dict[str, object], summary["input_contract"])[
            "selected_codes"
        ]
    ]
    ...
    return {
        ...
        "source_covariance_verdict": cast(dict[str, object], summary["aggregate"])[
...
def main() -> None:
    ...
    selected_codes = [
        str(code)
        for code in cast(dict[str, object], source_summary["input_contract"])[
            "selected_codes"
        ]
    ]
