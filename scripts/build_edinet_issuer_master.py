...
from src.io.market_data_sources import EDINET_CODELIST_URL, diff_issuer_masters, parse_edinet_code_zip, utc_now_iso


def fetch(url: str) -> bytes:
    req = Request(url, headers={"User-Agent": "KAFKA2306/investor2 EDINET issuer master"})
...
def main() -> int:
    ...
    print(json.dumps({"issuer_count": master["issuer_count"], "source_sha256": master["source_sha256"], "change_count": diff["change_count"]}))
    return 0
